...
date: 2011-03-17
tags: ["ASP.NET"]
slug: "frustrating-error-267-only-one-ltconfigsectionsgt-element-allowed-per-config-fil"
description: "I recently experienced this issue and struggled to find a solution. After reading through the many blogs and forums a [Google search..."
aliases:
  - "/2011/03/frustrating-error-267-only-one-element.html"
---
